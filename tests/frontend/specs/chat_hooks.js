...
describe('chat hooks', function () {
  ...
  const loadPad = async (opts = {}) => {
    ...
    ChatMessage = helper.padChrome$.window.require('md_mudoc-lite/static/js/ChatMessage');
    ({hooks} = helper.padChrome$.window.require('md_mudoc-lite/static/js/pluginfw/plugin_defs'));

...
describe(__filename, function () {
  ...
  const packages = [
    '/javascripts/lib/md_mudoc-lite/static/js/ace2_common.js?callback=require.define',
    '/javascripts/lib/md_mudoc-lite/static/js/ace2_inner.js?callback=require.define',
    '/javascripts/lib/md_mudoc-lite/static/js/pad.js?callback=require.define',
    '/javascripts/lib/md_mudoc-lite/static/js/timeslider.js?callback=require.define',
  ];

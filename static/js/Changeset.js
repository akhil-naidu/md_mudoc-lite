 ...
 * https://github.com/akhil-naidu/pad/blob/master/infrastructure/ace/www/easysync2.js
 */
    ...
    if (L) {
      ...
      if (!this._curSplice[sline]) {
        const err = new Error(
            ...
            'https://github.com/akhil-naidu/mudoc-lite/issues/2802');
...
exports.moveOpsToNewPool = (cs, oldPool, newPool) => {
  ...
  return upToDollar.replace(/\*([0-9a-z]+)/g, (_, a) => {
    ...
    // timeslider and text is deleted. See: https://github.com/akhil-naidu/mudoc-lite/issues/3932
    if (!pair) return '';

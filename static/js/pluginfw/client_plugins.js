...
const adoptPluginsFromAncestorsOf = (frame) => {
  ...
  const ancestorPluginDefs = parentRequire('md_mudoc-lite/static/js/pluginfw/plugin_defs');
  ...
  const ancestorPlugins = parentRequire('md_mudoc-lite/static/js/pluginfw/client_plugins');

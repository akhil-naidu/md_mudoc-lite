...
function Ace2Inner(editorInfo, cssManagers) {
  ...
  const setAuthorInfo = (author, info) => {
    ...
    if ((typeof author) !== 'string') {
      // Potentially caused by: https://github.com/akhil-naidu/mudoc-lite/issues/2802");
  ...
  const setDocAText = (atext) => {
    if (atext.text === '') {
       ...
       *
       * See for reference:
       * - https://github.com/akhil-naidu/mudoc-lite/issues/3861
       */
      atext.text = '\n';
    }
  ...
  const bindTheEventHandlers = () => {
    ...
    $(document.body).on('auxclick', (e) => {
      if (e.originalEvent.button === 1 && (e.target.a || e.target.localName === 'a')) {
        ...
        //     menu (https://github.com/akhil-naidu/mudoc-lite/issues/2775) so we cannot simply
  ...
  const updateLineNumbers = () => {
    ...
    // Original Issue: https://github.com/akhil-naidu/mudoc-lite/issues/4527
    const lineHeights = [];

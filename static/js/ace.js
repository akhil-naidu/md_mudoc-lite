...
const Ace2Editor = function () {
  ...
  this.init = async function (containerId, initialCode) {
    ...
    for (const module of ['ace2_inner', 'ace2_common']) {
      ...
      script.src = absUrl(`../javascripts/lib/md_mudoc-lite/static/js/${module}.js` +
    ...
    innerWindow.Ace2Inner = require('md_mudoc-lite/static/js/ace2_inner');
    innerWindow.plugins = require('md_mudoc-lite/static/js/pluginfw/client_plugins');
    innerWindow.plugins.adoptPluginsFromAncestorsOf(innerWindow);

    innerWindow.$ = innerWindow.jQuery = require('md_mudoc-lite/static/js/rjquery').jQuery;

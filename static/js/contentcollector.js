...
const makeContentCollector = (collectStyles, abrowser, apool, className2Author) => {
  ...
  const _recalcAttribString = (state) => {
    ...
    for (const [a, count] of Object.entries(state.attribs)) {
      ...
      // see https://github.com/akhil-naidu/mudoc-lite/issues/2567 for more information
  ...
  cc.collectContent = function (node, state) {
      ...
      if (tname === 'br') {
        ...
        if (collectStyles) {
          ...
          if (tname === 'ul' || tname === 'ol') {
            ...
            // See https://github.com/akhil-naidu/mudoc-lite/issues/2412 for reasoning
    ...
    if (isBlock) {
      if (lines.length() - 1 === startLine) {
        ...
        // commented out to solve #2412 - https://github.com/akhil-naidu/mudoc-lite/issues/2412

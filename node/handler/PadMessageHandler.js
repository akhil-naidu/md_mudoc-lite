 ...
 *   See https://github.com/akhil-naidu/pad/blob/master/etherpad/src/etherpad/collab/collab_server.js in the function applyUserChanges()
 *
 * @param socket the socket.io Socket object for the client
 * @param message the message from the client
 */
  ...
  await Promise.all(authors.map(async (authorId) => {
    ...
    if (!author) {
      messageLogger.error(`There is no author for authorId: ${authorId}. ` +
          'This is possibly related to https://github.com/akhil-naidu/mudoc-lite/issues/2802');
    } else {
 ...
 * https://github.com/akhil-naidu/pad/blob/master/etherpad/src/etherpad/control/pad/pad_changeset_control.js#L144
 */
 ...
 * https://github.com/akhil-naidu/pad/blob/master/etherpad/src/etherpad/control/pad/pad_changeset_control.js#L263
 */
 ...
 * https://github.com/akhil-naidu/pad/blob/master/etherpad/src/etherpad/control/pad/pad_changeset_control.js#L241
 */
...
exports.padUsers = async (padID) => {
  ...
  await Promise.all(_getRoomSockets(padID).map(async (roomSocket) => {
    ...
    if (s) {
      ...
      // Fixes: https://github.com/akhil-naidu/mudoc-lite/issues/4120

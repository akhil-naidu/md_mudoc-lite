...
exports.expressPreSession = async (hookName, {app}) => {
  ...
  app.get('/javascript', (req, res) => {
    res.send(eejs.require('md_mudoc-lite/templates/javascript.html', {req}));
  });
...
exports.expressCreateServer = (hookName, args, cb) => {
  ...
  args.app.get('/', (req, res) => {
    res.send(eejs.require('md_mudoc-lite/templates/index.html', {req}));
  });
  ...
  args.app.get('/p/:pad', (req, res, next) => {
    ...
    res.send(eejs.require('md_mudoc-lite/templates/pad.html', {
      req,
      toolbar,
      isReadOnly,
    }));
  ...
  args.app.get('/p/:pad/timeslider', (req, res, next) => {
    ...
    res.send(eejs.require('md_mudoc-lite/templates/timeslider.html', {
      req,
      toolbar,
    }));
  });

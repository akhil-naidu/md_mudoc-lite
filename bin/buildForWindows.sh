...
log "create the zip..."
cd "$TMP_FOLDER"
zip -9 -r "$START_FOLDER"/mudoc-lite-win.zip ./* -x var

log "clean up..."
rm -rf "$TMP_FOLDER"

log "Finished. You can find the zip in the Etherpad root folder, it's called mudoc-lite-win.zip"
